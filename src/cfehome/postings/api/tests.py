...
# this test framework creates a new blank DB for testing purpose only
...
class BlogPostAPITestCase(APITestCase):
    ...
    def test_post_item(self):
        ...
        url = api_reverse("api-postings:post-create")
        with self.assertRaises(ValueError): # Raises ValueError in case of anonymous user (different from video)
